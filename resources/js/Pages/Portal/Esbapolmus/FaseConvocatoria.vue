                ...
                <div class="row contenedor_secciones">
                    ...
                    <div class="col-12 py-5">
                        <div class="container">
                            ...
                            <p class="text-justify">
                                Las y los postulantes a la Escuela Básica
                                Policial de Música, para acceder al “Prospecto
                                de Admisión”, realizarán el depósito bancario en
                                la entidad financiera autorizada, con el precio
                                establecido conforme a la Tabla de Precios para
                                el efecto.
                            </p>
                        </div>
                    </div>
