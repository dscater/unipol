...
const descargar = () => {
    const url = route("evaluacion_fisicas.descargar");
...
const subirArchivo = async () => {
    ...
    try {
        const response = await axios.post(
            route("evaluacion_fisicas.subir"),
            formData,
            {
                headers: {
...
<template>
    <Head title="Evaluación del Área de Aptitud Física"></Head>

    <Content>
        <template #header>
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Evaluación del Área de Aptitud Física</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
