...
const descargar = () => {
    const url = route("evaluacion_odontologicas.descargar");
...
const subirArchivo = async () => {
    ...
    try {
        const response = await axios.post(
            route("evaluacion_odontologicas.subir"),
            formData,
            {
                headers: {
...
<template>
    <Head title="Evaluación Odontológica"></Head>

    <Content>
        <template #header>
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Evaluación Odontológica</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <MiTable
                    ...
                    :cols="headers"
                    :api="true"
                    :url="route('evaluacion_odontologicas.paginado')"
                    :numPages="5"
