...
const descargar = () => {
    const url = route("evaluacion_conocimientos.descargar");
...
const subirArchivo = async () => {
    ...
    try {
        const response = await axios.post(
            route("evaluacion_conocimientos.subir"),
            formData,
            {
                headers: {
...
<template>
    ...
    <Content>
        <template #header>
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Evaluación del Área de Conocimientos</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            Evaluación del Área de Conocimientos
                        </li>
                    </ol>
                </div>
                <!-- /.col -->
