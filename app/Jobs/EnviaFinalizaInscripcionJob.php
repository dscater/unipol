...
class EnviaFinalizaInscripcionJob implements ShouldQueue
{
    use Queueable;
     ...
     */
    public function __construct(private $datos, private $postulante)
    {
        //
    }
    ...
    public function handle(): void
    {
        ...
        Mail::to($this->postulante->correo)
            ->send(new FinalizaInscripcionMail($this->datos));
    }
}
